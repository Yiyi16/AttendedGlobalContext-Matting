...
class ImageFileTest(ImageFile):
    def __init__(self,
        ...
        self.valid_fg_list = self._get_valid_names(self.fg_dir, self.alpha_dir, shuffle=False)
        self.valid_bg_list = self._get_valid_names(self.bg_dir, self.alpha_dir, shuffle=False)
